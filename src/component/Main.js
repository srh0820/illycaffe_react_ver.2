            ...
            <div className="container-1824">
                ...
                >
                    <SwiperSlide style={{ backgroundColor: '#FFF0EF' }} className={mainscss.slide1}>
                        <div className={mainscss.slidetext}>
                            <ul className='d-flex'>
                            ...
                            <h3>추석 선물 대전</h3>
                            <p className={mainscss.textred}>[Y3.3 캡슐커피커신 디스펜서 세트]</p>
                        ...
                        <div className={mainscss.slideimg} >
                    ...
                    <SwiperSlide style={{ backgroundColor: '#DFF4CF' }} className={mainscss.slide2}>
                        <div className={mainscss.slidetext}>
                            <h4>일리카페 신규 오픈</h4>
                            <h3>선릉 저스트코타워점</h3>
                            <p className={mainscss.textred}>OPENING EVENT</p>
                    ...
                    <SwiperSlide style={{ backgroundColor: '#EADACD' }} className={mainscss.slide3}>
                        <div className={mainscss.slidetext}>
                            <h4>일리 브랜드 전시회</h4>
                            <h3>LIVE HAPP<span className={mainscss.textred}>ILLY</span> IN SEOUL</h3>
                            <ul>
